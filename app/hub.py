    ...
    def create_new_wallet(self, mnemonic_seed=u'', restore_height=0):
        ...
        try:
            ...
            if has_password:
                ...
                wallet_log_path = os.path.join(wallet_dir_path, 'gallus-wallet-cli.log')
...
#                     self.wallet_cli_manager.send_command("exit")
    ...
    def restart_daemon(self):
        self.app_process_events(1)
        self.ui.galluscoind_daemon_manager.stop()
    ...
    def view_daemon_log(self):
        log_file = os.path.join(DATA_DIR, 'logs', "galluscoind.log")
